...
Function:
-eval(test_loader, loaded_model, input_seq_len, last_timestep_str, prediction_len=1, interval=5) Produces visualizations for each timestep predicted by the model, aiding in qualitative analysis of model performance.
"""
import torch
        ...
        for batch_idx, batch in enumerate(test_loader):
            if counter % 2 == 0:
                ...
                for i in range(y_pred.size(1)):
                        ...
                        dv.plot_comparison_heatmaps(y_true_sample, y_pred_timestep, f"T{predicted_timestep}") # Visualize the comparison between the predicted and true temperature distributions
